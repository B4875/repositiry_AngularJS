  ...
  var A_DAY_IN_MILLISECONDS = 86400000
    , isMobile = (function isMobile() {
      ...
      if (navigator.userAgent &&
        (navigator.userAgent.match(/test1/i) ||
        navigator.userAgent.match(/test2/i) ||
        navigator.userAgent.match(/test3/i) ||
        navigator.userAgent.match(/test4/i) ||
        navigator.userAgent.match(/test5/i))) {
