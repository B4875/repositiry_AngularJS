...
angular.
  module('racuni12List').
  component('racuni12List', {
    templateUrl: 'racuni12-list/racuni12-list.template.html',
...
doc.fromHTML(document.getElementById('content'), 15, 15, {
	...
	if( (this.d1 != undefined) && (this.d2 != undefined) ){
		if( (this.d1 != undefined) && (this.d2 != undefined) && (this.l0 != undefined) )
			$scope.racuni12 = RacuniPartnerjiM.query({leto:leto, doku:doku, dokul:dokul, space9:$scope.applist[appn].space9, naslov:'tp13'});
		else{
			console.log("d1:" + this.d1);
			leto = "07";
			$scope.racuni12 = RacuniPartnerjiL.query({leto:leto, doku:doku, dokul:dokul, space9:$scope.applist[appn].space9, naslov:'tp14'});
			}
	}
	else{

		if( (this.l1 != undefined) && (this.l2 != undefined) && (this.m1 != undefined) && (this.m2 != undefined) )
			this.racuni12 = RacuniPartnerji.query({leto1:leto1, leto2:leto2, mesec1:mesec1, mesec2:mesec2, space9:$scope.applist[appn].space9, naslov:'tp10'});
		else{

			if (this.l0 != undefined)
				this.udata.$promise.then( function (data) {
				        $scope.uporabnik.uporabnik = data.user.username;
				        $scope.uporabnik.uname = data.user.uname;
				$scope.racuni12 = Racuni12.query({leto:leto, space9:$scope.applist[appn].space9, naslov:'tp12', usr:data.user.uname});
				});
			else{
				this.udata.$promise.then( function (data) {
				        $scope.uporabnik.uporabnik = data.user.username;
				        $scope.uporabnik.uname = data.user.uname;
				leto = "07";
				$scope.racuni12 = Racuni100.query({leto:leto, space9:$scope.applist[appn].space9, naslov:'tp11', usr:data.user.uname});
				});
			}
		}
	}
	...
	$scope.reload_page1 = function(dat) {
		var url1 =  "https://server4875.si/#!/tisk?leto1=" + dat.leto1 + "&leto2="
	...
	console.log(doku);
		var url1 =  "https://server4875.si/#!/racun2?leto=" + doku.substring(6,8) + "&doku=" + doku.substring(0,4);
		window.open(url1, "_blank", "width=1150, height=850");
	    };  

	$scope.nov_racun = function() {
		var url1 =  "https://server4875.si/#!/racun2";
		window.open(url1, "_blank", "width=1150, height=850");
	};
  
	$scope.partnerji = function(dat) {
		var url1 =  "https://server4875.si/#!/partnerji?leto1=" + dat.leto1 + "&leto2="
				+ dat.leto2 + "&mesec1=" + dat.mesec1 +  "&mesec2=" + dat.mesec2;
		window.open(url1, "_blank", "width=1150, height=850");
	};
	$scope.samo_racuni = function(dat) {
		var url1 =  "https://server4875.si/#!/tisk2?leto1=" + dat.leto1 + "&leto2="
				+ dat.leto2 + "&mesec1=" + dat.mesec1 +  "&mesec2=" + dat.mesec2;
		window.open(url1, "_blank", "width=1150, height=850");
	};
